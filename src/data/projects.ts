...
export const projects: Project[] = [
  {
    ...
    thumbnail: "/images/collegemart/1.webp",
    ...
    images: [
      { id: 1, alt: "College Mart homepage" },
      { id: 2, alt: "Product listings page" },
      { id: 3, alt: "Product detail view" }
    ],
    month: "Aug-Oct",
    year: "2025"
  },
  {
    ...
    thumbnail: "/images/swaagfun/1.webp",
    ...
    images: [
      { id: 1, alt: "Swaagfun main feed" },
      { id: 2, alt: "User profile page" },
      { id: 3, alt: "Post creation interface" }
    ],
    month: "Jun-Jul",
    year: "2024"
  },
  {
    ...
    thumbnail: "/images/homestayz/1.webp",
    ...
    images: [
      { id: 1, alt: "Homestayz homepage" },
      { id: 2, alt: "Property details page" },
      { id: 3, alt: "Booking interface" }
    ],
    month: "March",
    year: "2024"
  },
  {
    ...
    thumbnail: "/images/journal/1.webp",
    ...
    images: [
      { id: 1, alt: "JournalHub dashboard" },
      { id: 2, alt: "Journal entry editor" },
      { id: 3, alt: "Statistics and tracking" }
    ],
    month: "February",
    year: "2024"
  }
